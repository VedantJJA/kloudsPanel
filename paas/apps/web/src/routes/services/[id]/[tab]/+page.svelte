        ...
        <div style="display:flex; align-items:center; gap:0.5rem; flex-wrap:wrap;">
          ...
          <div style="display:inline-flex; background:var(--color-canvas); border:1px solid var(--color-border); border-radius:var(--radius-sm); padding:2px;">
            <button
              type="button"
              class="btn"
              style="padding:3px 10px; font-size:0.75rem; font-weight:{envMode === 'form' ? '700' : '500'}; color:{envMode === 'form' ? 'var(--color-ink)' : 'var(--color-ink-secondary)'}; background:{envMode === 'form' ? 'var(--color-surface)' : 'transparent'}; box-shadow:{envMode === 'form' ? 'var(--shadow-sm)' : 'none'}; border:none;"
            ...
            <button
              type="button"
              class="btn"
              style="padding:3px 10px; font-size:0.75rem; font-weight:{envMode === 'raw' ? '700' : '500'}; color:{envMode === 'raw' ? 'var(--color-ink)' : 'var(--color-ink-secondary)'}; background:{envMode === 'raw' ? 'var(--color-surface)' : 'transparent'}; box-shadow:{envMode === 'raw' ? 'var(--shadow-sm)' : 'none'}; border:none;"
